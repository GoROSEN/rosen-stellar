module github.com/GoROSEN/rosen-apiserver
...
require (
	github.com/GoROSEN/go-circle-web3-service v0.0.0-20240901081925-8c0f7bc58882
	...
	github.com/duyquang6/go-xss-filter v0.0.0-20191103093916-89a066b378df
